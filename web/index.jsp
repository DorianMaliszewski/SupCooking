            ...
            <c:forEach var="recipe" items="${recipes}">
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            <p class="card-text">${recipe.name} <br/> ${!empty recipe.numberOfView ? recipe.numberOfView : "0" } vue${recipe.numberOfView > 1 ? "s" : ""} - ${!empty recipe.numberOfMark ? recipe.numberOfMark : "0" } note${recipe.numberOfMark > 1 ? "s" : ""} - ${recipe.formattedMark}</p>
