    ...
    <jsp:body>
        ...
        <form>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="username" aria-describedby="usernameHelp" placeholder="ID">
                <small id="usernameHelp" class="form-text text-muted">Choisissez un identifiant.</small>
            </div>
            <div class="form-group">
                <label for="password">Mot de passe</label>
                <input type="password" class="form-control" id="password" placeholder="Mot de passe" aria-describedby="passHelp">
